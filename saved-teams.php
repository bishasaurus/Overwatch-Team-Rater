...
<br>
<p>In this page, you can view saved teams' rating again. To do so, choose the team you desire by scrolling to right and pressing <span style="color:orange;">Rate Team</span> -button on the same row as the team which rating you want to view. You can see the team's creator's name in the last column of the row.</p>
...
<div class="table-responsive">
	<div class="row">
		<div class="col" >     
			...
			$sql = "SELECT * FROM myteamsX LIMIT 30"; 
