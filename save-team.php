	...
	<div class="row">
		<div class="col" >     
			...
			<?php 
				...
				// get the values entered in the team-rater.php's form, which consist of the Heros' names originally received from index.php. Also gets the user name, if user has logged in with an account
				...
				if($result->num_rows >= 30){
					echo ("Team storage full, delete some teams in <a style='color:orange;' href='manage-teams.php'>Manage Teams</a> -page.");
				...
				$sql = "INSERT INTO myteamsX (heroName1, heroName2, heroName3, heroName4, heroName5, heroName6, creator) VALUES
									('$hero1', '$hero2', '$hero3', '$hero4', '$hero5', '$hero6', '$creator')";
